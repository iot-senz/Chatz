...
import com.score.senz.chatz.MainActivity;
import com.score.senz.chatz.R;
...
public class NotificationUtils {
    ...
    public static void showNotification(Context context, String title, String message) {
        ...
        Notification notification = NotificationUtils.getNotification(context, R.drawable.noti, title, message);
    ...
    public static void updateNotification(Context context, String message) {
        Notification notification = getNotification(context, R.drawable.noti, context.getString(R.string.new_senz), message);
        notification.flags |= Notification.FLAG_AUTO_CANCEL;
        NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
